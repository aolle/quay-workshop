...
* On the Install Operator page, select `stable-3.7` from the list of available Update Channel options. Then, choose `All namespaces on the cluster (default)` as the installation mode and select `Automatic` for update approval.

...
* From the Red Hat Quay Dashboard, navigate to the `olleb/kafka` repository. Recall from xref:quay-repos.adoc[Repositories] that we previously created and pushed a `strimzi/kafka` image.

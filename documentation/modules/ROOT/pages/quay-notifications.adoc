...
. From the Red Hat Quay Dashboard, navigate to the `olleb/kafka` repository. 
+
_(Recall from xref:quay-repos.adoc[Repository Management] that this repository was previously created when we pushed the `strimzi/kafka` image)._

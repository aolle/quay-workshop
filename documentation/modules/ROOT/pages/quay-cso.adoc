...
* On `vuln-httpd` project; deploy the vulnerable image, click Workloads → Deployments. Click on `Create Deployment`.
...
* Click on `View all` and click on the Manifest related to `olleb/httpd-24`.

...
* Red Hat OpenShift will start the deployment and create the pod. Go to `Workloads` → `Pods` and select one of the `jmxtrans` pods. Then open the `Vulnerabilities` tab.

...
* Click the `SHA256` value under `MANIFEST` of the `3.1.0` tag to see the layers dashboard.
...
* Create a new image repository as already explained. I created the `olleb/rollback` repository.
